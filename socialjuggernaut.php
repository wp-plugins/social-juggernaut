...
.icon {
	...
	if(!empty($options["facebook"])) {
		echo "<a href='" . $options["facebook"] . "'><img class='icon' src='";?><?php echo bloginfo('url'); ?><?php echo "/wp-content/plugins/socialjuggernaut/images/32px/facebook.png'/></a>";
	}
	if(!empty($options["twitter"])) {
		echo "<a href='" . $options["twitter"] . "'><img class='icon' src='";?><?php echo bloginfo('url'); ?><?php echo "/wp-content/plugins/socialjuggernaut/images/32px/twitter.png'/></a>";
	}
	if(!empty($options["posterous"])) {
		echo "<a href='" . $options["posterous"] . "'><img class='icon' src='";?><?php echo bloginfo('url'); ?><?php echo "/wp-content/plugins/socialjuggernaut/images/32px/posterous.png'/></a>";
	}
	if(!empty($options["linkedin"])) {
		echo "<a href='" . $options["linkedin"] . "'><img class='icon' src='";?><?php echo bloginfo('url'); ?><?php echo "/wp-content/plugins/socialjuggernaut/images/32px/linkedin.png'/></a>";
	}	
	if(!empty($options["rss"])) {
		echo "<a href='" . $options["rss"] . "'><img class='icon' src='";?><?php echo bloginfo('url'); ?><?php echo "/wp-content/plugins/socialjuggernaut/images/32px/rss.png'/></a>";
	}			
}
